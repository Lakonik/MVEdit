...
def create_interface_img_to_3d(
        ...
        n_inverse_steps=96, diff_bs=6, tet_resolution=128, superres_n_inverse_steps=48, num_passes=6,
        pred_normal=False):
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                create_base_opts(
                    ...
                    steps=24, denoising_strength=0.5, random_init=False, cfg_scale=nerf_mesh_defaults['cfg_scale'])
                ...
                if advanced:
                    ...
                    create_optimization_opts(
                        ...
                        tet_resolution=tet_resolution,
                        **{key: nerf_mesh_defaults[key] for key in ['tet_init_inverse_steps', 'start_lr', 'end_lr']})
